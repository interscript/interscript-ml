...
|Byte-identical output across runtimes (full precision) |A single artifact contract with per-member checksums and cross-runtime golden sets; quantized artifacts carry measured quality deltas instead — near-tie decisions flip across hardware
